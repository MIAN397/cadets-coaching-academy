...
import type { UserProfile, UserRole, AttendanceRecord, Quiz, Submission } from '../types';
import { REGISTRATION_CATEGORIES } from '../types';
import { Shield, RefreshCw, Users, BookOpen, FileCheck, Calendar, Check, AlertCircle, Plus, DollarSign, Search } from 'lucide-react';
...
export const DeveloperDashboard: React.FC<{ developerUid: string; developerEmail: string }> = ({ developerUid, developerEmail }) => {
  ...
  const [activeTab, setActiveTab] = useState<'controls' | 'attendance' | 'quizzes' | 'financials'>('controls');
